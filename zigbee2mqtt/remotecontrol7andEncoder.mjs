...
/* MQTT stays readable. Radio downlink is binary to avoid base64 expansion:
 * A -> random8||rawECDSAsig64 = 72 bytes; P -> ciphertext||GCMtag; D -> ASCII. */
