...
const remoteFromOnOff={cluster:'genOnOff',type:['attributeReport','readResponse'],convert:(model,msg)=>{if(msg.data.onOff===undefined)return;const n=endpointNameById(msg.endpoint.ID);if(!n)return;return{[`state_${n}`]:msg.data.onOff?'ON':'OFF'};}};
